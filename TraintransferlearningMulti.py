...
from PosterMultiClass import PosterMultiClass
...
train_db = PosterMultiClass(transform_train, mode='train')
val_db = PosterMultiClass(transform_test, mode='validation')
    ...
    for epoch in range(epochs):
        ...
        if epoch % 1 == 0:
            ...
            if val_acc > best_acc:
                ...
                torch.save(model.state_dict(), 'SGD-moment-best-1-multi-class.mdl')
