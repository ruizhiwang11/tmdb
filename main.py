...
# df = df[header]
# df['isThriller'] = df['genre_ids'].apply(lambda x: True if '27' in x else False)
# print(df.head(100))
...
# train_df[["poster_path","isThriller","id"]].to_csv("train.csv",index=False,header=None)
# test_df[["poster_path","isThriller","id"]].to_csv("test.csv",index=False,header=None)
